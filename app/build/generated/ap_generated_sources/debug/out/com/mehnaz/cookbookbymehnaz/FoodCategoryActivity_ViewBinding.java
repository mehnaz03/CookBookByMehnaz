...
public class FoodCategoryActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public FoodCategoryActivity_ViewBinding(FoodCategoryActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public FoodCategoryActivity_ViewBinding(FoodCategoryActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FoodCategoryActivity target = this.target;
